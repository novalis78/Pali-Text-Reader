...
namespace PaliReaderUtils
{
	...
	public class AalekhDecoder
	{
		...
		public char[] AalekhToUnicode(byte[] alekhArray, bool countOnly,bool StripNonAalekh)
		{
          ...
          {		  
          	switch(alekhArray[y])
			{
				...
				case 0x0a: 
				{
					if(y>0 && (char)alekhArray[y-1]==(char)0x0d)
						rArray.Add((char) (0x0a));//LF
					else
						rArray.Add((char) (0x20));//space
				...
				case 0xa0: rArray.Add((char)  0x20); break;
				...
				case 0xfc: rArray.Add((char)  'O'); break;//Other
				...
				case 0xcf: rArray.Add(capitalMode ? (char) 0x4F :(char) 0x6f); capitalMode = false; break;//o
        	   	...
        	   	case 0xd6: {rArray.Add(capitalMode ? 'G' : (char) 0x67); 
				...
				case 0xe1: {rArray.Add(capitalMode ? (char) 0x4a : (char) 0x6a);
        	   	...
        	   	case 0xe7: rArray.Add(capitalMode ? (char) 0x1e46 : (char) 0x1e47); capitalMode = false; break;//n.
...
/*		
		public static void UnzipFromZipLibrary(string bookName)
		{
			...
			{
				MessageBox.Show("Please make sure, that you seperatly download the " +
				                "Pali Text Canon archive file (\"canon.zip\") from " +
				                "our project web site.\r\n For all alpha versions, " +
				                "this file has to be downloaded seperatly in order " +
				                "to minimize the size of this software package.\r\n " +
				                "During BETA and later release stages, we will also provide a bundled version " +
				                "for those of you who do not want to download two " +
				                "separate files). \r\n\r\n After downloading the file, simply" +
				                " copy it into the installation folder of the " +
				                "Pali Text Reader and put it into the \"Canon\" " +
				                "named subdirectory. Older versions of this file are not" +
				                "compatible!!! \r\n\r\n Thank you. (For our project web" +
				                " site see Help Menu | Update).", "Please note: ");
				System.Diagnostics.Process.Start("iexplore", "http://prdownloads.sourceforge.net/palireader/canon.zip?download");
			}
