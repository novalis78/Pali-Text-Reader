...
namespace Splash
{
	...
	public class SplashScreen : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent() 
		{
			...
			resources = new System.ComponentModel.ComponentResourceManager(typeof(SplashScreen));
			...
			this.pnlStatus.Location = new System.Drawing.Point(0, 216);
			this.pnlStatus.Name = "pnlStatus";
			this.pnlStatus.Size = new System.Drawing.Size(421, 5);
			...
			this.lblTimeRemaining.Location = new System.Drawing.Point(280, 52);
			this.lblTimeRemaining.Name = "lblTimeRemaining";
			this.lblTimeRemaining.Size = new System.Drawing.Size(144, 25);
			...
			this.lblStatus.Location = new System.Drawing.Point(8, 149);
			this.lblStatus.Name = "lblStatus";
			this.lblStatus.Size = new System.Drawing.Size(216, 35);
			...
			Random r = new Random();
			this.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("$this.splash" + r.Next(1, 6).ToString())));
		...
		private void SetReferenceInternal()
		{
			...
			{
				MessageBox.Show(" 444444444444 Error: " + ex.ToString());
			}
		}
		...
		private void ReadIncrements()
		{
			...
			{
				MessageBox.Show(" 3333333333333 Error: " + ex.ToString());
			}
		}
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			...
			if( m_bFirstLaunch == false && m_dblLastCompletionFraction < m_dblCompletionFraction )
			{
				...
				{
					MessageBox.Show(" 222222222 Error: " + ex.ToString());
				}
			}
		}
		...
		private void pnlStatus_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			try
			{
				...
				{
					if (m_rProgress != null && m_rProgress.Width > 0)
					{
			...
			{
				//Unhandled exception due to paint of empty rectangle
				MessageBox.Show(" 11111111111 Error: " + ex.ToString());
			}
		}
