...
Name "Pali Text Reader Online Edition v. 0.1.1.50"
BrandingText "B.E. 2550 Pali Software Tools"
XPStyle on
OutFile "Output\PaliTextReader_OnlineEdition.exe"
...
Section -Files
  ...
  File "license.txt"
  File "PaliReader.url"
  File "PaliReader.exe.xml" #Different params for online edition...
